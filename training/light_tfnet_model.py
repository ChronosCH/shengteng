...
class LightTFNetModel(nn.Cell):
    ...
    def __init__(self, hidden_size, word_set_num, device_target="CPU", dataset_name='CE-CSL'):
        ...
        self.temporal_model = nn.LSTM(
            ...
            hidden_size=hidden_size//2,  # 减少LSTM隐藏层大小
            num_layers=1,  # 减少层数
            bidirectional=True,
    ...
    def _build_light_backbone(self):
        ...
        return nn.SequentialCell([
            ...
            # 全局平均池化
            nn.AdaptiveAvgPool2d((2, 2)),  # 14x14 -> 2x2
    ...
    def construct(self, seq_data, data_len=None, is_train=True):
        ...
        features = self.conv2d(inputs)  # (B*T, 256)
